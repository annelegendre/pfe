...
learning_rate = 0.00005 # 0.000095 for cartpole
s_size = STATE_SIZE # defined in MCIC_env.py (93)
a_size = ACTION_SIZE # defined in MCIC_env.py (120: 60 alphas and 60 betas)
load_model = False
model_path = './model'
# -----------------------
# main 
